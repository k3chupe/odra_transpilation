"""Genetic algorithm routing solver over layouts.

The fidelity-aware GA with full encoding (layout+swaps+flags) lives in ``routing/genetic_fidelity.py``.
"""
...
class GeneticSearchSolver:
    ...
    ponytail: layout-only crossover with greedy mapping, identical
    to how TabuSearchSolver (without fidelity) operates.
    """
...
def _register() -> None:
    register_solver(GeneticSearchSolver())
